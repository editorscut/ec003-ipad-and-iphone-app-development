...
- (NSMutableArray *)annotations {
    NSString *mostRecentPin
         = [[NSUserDefaults standardUserDefaults] valueForKey:@"mostRecentPin"];
    NSLog(@"%@", mostRecentPin);
    if (! _annotations) {
...
- (SCSPlace *)annotationForLocation:(CLLocationCoordinate2D)coordinate
    ...
    [[NSUserDefaults standardUserDefaults] setValue:places
                                             forKey:@"annotationTitles"];
    return place;
}
@end
